...
let name = "Erick"
let age = 19
let iLikeProgramming = true
console.log(`Meu nome é ${name}, eu tenho ${age} anos e se eu gosto de programar?${iLikeProgramming}`)
...
let number = 10;
let number2 = 20;
console.log(`Soma: ${number + number2}. Multiplicacao: ${number * number2}. Divisao ${number / number2}. Resto da Divisao ${number % number2}`)
...
let numberAl = 1
let numberAl2 = 2
console.log(`Sao iguais? ${numberAl === numberAl2}. Sao diferentes? ${numberAl !== numberAl2}. O primeiro é maior? ${numberAl > numberAl2}. O segundo é menor ou igual? ${numberAl2 <= numberAl}`)
...
let b = false
let c = true
console.log(`A e B: ${a && b}. B e C: ${b && c}. A e C: ${a && c}. A ou B: ${a || b}. B ou C: ${b || c}. Nega a: ${!a}. Nega b: ${!b}`)
*/
...
// =========================================
let digite = ask.question("Digite um numero: ");

let value = digite.toString()
